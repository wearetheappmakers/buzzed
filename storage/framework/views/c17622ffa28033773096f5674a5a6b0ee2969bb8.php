        ...
        <div class="col-lg-4">
             <?php if($edit->image): ?>
                <div class="image_layer">
                    <div class="image_div">
                        <a target="_blank"  href="<?php echo e(url('storage/uploads/users/'.$edit->image)); ?>" rel="gallery" class="fancybox" title="">
                            <img src="<?php echo e(url('storage/uploads/users/Tiny/'.$edit->image)); ?>" class="img-thumbnail" alt="<?php echo e($edit->image); ?>" />
                        </a>
                    </div>
                </div>
            <?php endif; ?>
