				...
				<div class="kt-portlet__head-toolbar">
					...
					<div class="kt-portlet__head-wrapper">
						...
						<div class="kt-portlet__head-actions">
							...
							<a href="<?php echo e(route('admin.membershipamount.create')); ?>" class="btn btn-brand btn-elevate btn-icon-sm">
...
<script>
	...
	$(document).ready(function() {
		...
		$('#datatable_rows').DataTable({
			...
			ajax: "<?php echo e(route('admin.membershipamount.index')); ?>",
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\rohit\buzzed\buzzed\resources\views/adminseller/membershipamount/index.blade.php ENDPATH**/ ?>