...
<form class="kt-form login_form" id="login_form"  role="form" method="POST" action="<?php echo e(url('/waiter/login')); ?>">
                        <?php echo e(csrf_field()); ?>

                        	<div class="kt-login__signin">
								<div class="kt-login__head">
									<h3 class="kt-login__title">Sign In To Waiter</h3>
								</div>
								</div>
...
<?php if($errors->has('password')): ?>
	                        ...
	                        <div class="row kt-login__extra">
									...
									<div class="col kt-align-right">
										<a href="<?php echo e(url('/waiter/password/reset')); ?>" class="kt-login__link">Forget Password ?</a>
									</div>
								</div>
...
<?php echo $__env->make('admin.layout.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\rohit\buzzed\buzzed\resources\views/waiter/auth/login.blade.php ENDPATH**/ ?>