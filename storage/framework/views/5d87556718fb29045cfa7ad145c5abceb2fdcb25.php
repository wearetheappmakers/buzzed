...
<div class="kt-portlet__body">
    <div class="form-group row">
        ...
        <div class="col-lg-4">
            <label>Number:</label>
            <input type="text" class="form-control" placeholder="Enter number" onkeypress="return isNumber(event)" maxlength="10" name="number" value="<?php echo e($edit->number); ?>" id="number" required autocomplete="off">
        </div>
        <div class="col-lg-4">
            <label>Outlet:</label>
            <select class="form-control" name="outlet" required="">
                ...
                <?php if(!empty($outlet)): ?>
                    <?php $__currentLoopData = $outlet; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ol): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($ol->id); ?>" <?php if($ol->id == $edit->outlet): ?> selected <?php endif; ?>><?php echo e($ol->name); ?></option>
...
</div><?php /**PATH D:\rohit\buzzed\buzzed\resources\views/adminseller/captain/edit.blade.php ENDPATH**/ ?>