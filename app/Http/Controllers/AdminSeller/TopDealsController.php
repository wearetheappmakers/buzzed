...
class TopDealsController extends Controller
{
    ...
    public function index(Request $request){
        ...
        if ($request->ajax()) {
            $query = TopDeals::where('deleted_at', NULL)->latest()->get();
    ...
    public function edit(Request $request,$id)
    {
        ...
        $data['edit'] = TopDeals::findOrFail($id);
    ...
    public function update(Request $request)
    {
        ...
        $brand = TopDeals::findOrFail($request->id);
    ...
    {
        $result = TopDeals::where('id',$request->id)->delete();
