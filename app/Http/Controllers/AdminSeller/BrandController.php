...
class BrandController extends Controller
{
    ...
    public function index(Request $request){
        ...
        if ($request->ajax()) {
            $query = Brand::where('deleted_at', NULL)->latest()->get();
            ...
            return Datatables::of($query)
                ...
                ->editColumn('image', function ($row) {
                    return view('admin.layout.image')->with(['image'=>$row->image,'folder_name'=>'brand']);
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('image')) {
            $name = ImageHelper::saveUploadedImage(request()->image, $type, storage_path("app/public/uploads/brand/"));
            $param['image']= $name;
        }
    ...
    public function update(Request $request)
    {
        ...
        if ($request->hasFile('image')) {
            $name = ImageHelper::saveUploadedImage(request()->image, $type, storage_path("app/public/uploads/brand/"), $brand->image);
            $param['image']= $name;
        }
        $brand->update($param);
