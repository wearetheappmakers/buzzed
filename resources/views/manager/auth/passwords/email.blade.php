...
<div class="">
    ...
    @endif
    <form class="kt-form" method="POST" role="form" action="{{ url('/manager/password/email') }}">
        {{ csrf_field() }}
        ...
        <button class="btn btn-light btn-elevate kt-login__btn-secondary"><a href="{{url('manager/login')}}">Cancel</a></button>
        </div>
    </form>
</div>
@endsection
