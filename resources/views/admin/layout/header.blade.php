					...
					<div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
						...
						<ul class="kt-menu__nav ">
							...
							@if(Auth::guard('manager')->check())
								...
								<li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true"><a href="{{route('manager.captain.index')}}" class="kt-menu__link "><i class="kt-menu__link-icon fas fa-users"></i><span class="kt-menu__link-text">Captain</span></a></li>

								<li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true"><a href="{{route('manager.vendors.index','all')}}" class="kt-menu__link "><i class="kt-menu__link-icon fas fa-users"></i><span class="kt-menu__link-text">Customer</span></a></li>

							@endif

							@if(Auth::guard('waiter')->check())
							
								<li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true"><a href="{{route('waiter.order.index')}}" class="kt-menu__link "><i class="kt-menu__link-icon fas fa-users"></i><span class="kt-menu__link-text">All Bills</span></a></li>

							@endif

							@if(Auth::guard('admin')->check())

							<li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true"><a href="{{route('admin.order.index')}}" class="kt-menu__link "><i class="kt-menu__link-icon fas fa-users"></i><span class="kt-menu__link-text">All Bills</span></a></li>
							...
							<li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true"><a href="{{route('admin.captain.index')}}" class="kt-menu__link "><i class="kt-menu__link-icon fas fa-users"></i><span class="kt-menu__link-text">Captain</span></a></li>
							...
							<li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true"><a href="{{route('admin.membershipamount.index')}}" class="kt-menu__link "><i class="kt-menu__link-icon fas fa-users"></i><span class="kt-menu__link-text">Membership Amount</span></a></li>
							...
							<li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true"><a href="{{route('admin.staff.index')}}" class="kt-menu__link "><i class="kt-menu__link-icon fas fa-users"></i><span class="kt-menu__link-text">Operations Manager / Waiters</span></a></li>
