						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="alert alert-custom alert-white alert-shadow gutter-b" role="alert">
									...
									<div class="alert-text">This example shows a vertically scrolling DataTable that makes  of the CSS3 vh unit in order to dynamically resize the viewport based on the browser window height.</div>
								</div>
								<!--end::Notice-->  --}}
								<!--begin::Card-->
								<div class="card card-custom gutter-b">
									<div class="card-header flex-wrap border-0 pt-6 pb-0">
										<div class="card-title">
											<h3 class="card-label">Show Link
											<span class="d-block text-muted pt-2 font-size-sm">Show your referral link</span></h3>
										</div>
									...
									<div class="card-body">
										...
										<table id="myTable" class="table table-striped">
											...
											<tbody>
												...
												<?php
													$pendingComm =  \DB::table('user_comms')->where([['user_id', '=', $value->user_id],['product_id', '=',$value->product_id],['status', '=' ,0]])->sum('amount'); 
													$apComm =  \DB::table('user_comms')->where([['user_id', '=', $value->user_id],['product_id', '=',$value->product_id],['status', '=' ,1]])->sum('amount');
												?>
												<tr>
													<td>{{ $value->id }}</td>
													<td>{{ $value->link }}</td>
					...
					<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="text-dark order-2 order-md-1">
								...
								<a href="#" target="_blank" class="text-dark-75 text-hover-primary">Applified</a>
							</div>
							<!--end::Copyright-->
							<!--begin::Nav-->
