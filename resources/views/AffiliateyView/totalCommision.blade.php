								...
								<div class="card card-custom gutter-b">
									<div class="card-header flex-wrap border-0 pt-6 pb-0">
										<div class="card-title">
											<h3 class="card-label">Show Total Commision
											<span class="d-block text-muted pt-2 font-size-sm">Show Your Total Commision list</span></h3>
										</div>
									...
									<div class="card-body">
										...
										<table id="myTable" class="table table-striped">
											...
											<tbody>
												@foreach($total_commision as $value)
